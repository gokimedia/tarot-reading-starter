...
export const AN_AREAS = Object.freeze({
  love: Object.freeze({
    ...
    anchor: /\b(?:relationship|connection|partner|dating|trust)\b/i,
  ...
  person: Object.freeze({
    ...
    anchor: /\b(?:person|contact|they|them|their|notice)\b/i,
  ...
  career: Object.freeze({
    ...
    anchor: /\b(?:work|career|offer|job|money|decision|role|evidence)\b/i,
  ...
  change: Object.freeze({
    ...
    anchor: /\b(?:change|decision|move|transition|step|choice|test)\b/i,
  ...
  spirit: Object.freeze({
    ...
    anchor: /\b(?:pattern|inner|yourself|growth|lesson|self|answer)\b/i,
  ...
  several: Object.freeze({
    ...
    anchor: /\b(?:numbers?|pattern|sequences?|together|signs?|theme)\b/i,
...
function userPrompt(payload) {
  return `${previewFacts(payload)}\n\n` +
    'Write two fields:\n' +
    '1. situated: 34 to 68 words, 2 or 3 complete sentences in second person, present tense. Read the theme inside the chosen life area' +
...
export function auditPreview(result, payload) {
  ...
  if (sw < 24 || sw > 75) return `situated word count ${sw} outside 24-75`;
