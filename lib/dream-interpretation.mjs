...
export const DREAM_PRIVACY_MODE = 'Server-minimized · raw dream not sent to the interpretation model or checkout';
...
export function dreamEvidence(input, output) {
  ...
  return {
    ...
    context: 'Privacy-minimized result; Deckaura derived allowlisted themes, tone and a length band on its server, then sent only those signals to the interpretation model. Raw dream text was not sent to that model, retained, or attached to checkout.',
