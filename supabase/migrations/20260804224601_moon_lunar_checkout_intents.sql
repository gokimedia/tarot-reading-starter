...
alter table deckaura.checkout_intents
  ...
  check (deck in ('love_oracle', 'classic_tarot', 'natal_chart', 'natal_transits', 'big_three', 'angel_number', 'lunar_transits')),
...
-- Checkout intents include customer questions and birth details. They stay in
-- the private schema and are never directly reachable from browser roles.
