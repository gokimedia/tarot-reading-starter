...
alter table deckaura.checkout_intents
  ...
  check (deck in ('love_oracle', 'classic_tarot', 'natal_chart', 'natal_transits', 'big_three', 'angel_number', 'lunar_transits', 'numerology')),
...
-- The signed snapshot contains birth dates, customer questions and optional
-- full birth names. Browser roles must never read or mutate these records.
