...
-- checkout_intents lives in the private deckaura schema and remains worker-only.
-- Reassert the boundary after changing constraints so new public Data API defaults
-- cannot accidentally expose customer questions or relationship context.
