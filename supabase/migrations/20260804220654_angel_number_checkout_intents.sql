...
alter table deckaura.checkout_intents
  ...
  check (intent_kind is null or intent_kind in ('love_tarot', 'daily_tarot', 'birth_chart', 'big_three', 'angel_number')),
  ...
  check (
    ...
    or (intent_kind in ('love_tarot', 'daily_tarot', 'birth_chart', 'big_three', 'angel_number')
      and snapshot_hash ~ '^[a-f0-9]{64}$')
  ),
  add constraint checkout_intents_deck
  check (deck in ('love_oracle', 'classic_tarot', 'natal_chart', 'big_three', 'angel_number')),
