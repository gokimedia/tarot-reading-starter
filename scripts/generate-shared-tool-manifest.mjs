...
const EXPECTED_LIVE_PAGE_COUNT = 40;
...
function validate(products, pages, sharedEvents, commerceEvents) {
...
function render({ products, pages, sharedEvents, commerceEvents, funnelVersion, offerVariant, sourceDigest }) {
...
validate(products, themePages, sharedEvents, commerceEvents);
